...
Las redes se entrenaron durante 200 épocas para cada instrumento, es decir, primero se entreno la red para que generara patrones de guitarra y luego se entreno para bajo, por lo tanto se tienen resultados de los 2 procesos.
...
\begin{figure}[H]
	...
	\caption{Gráfica de error para bajo en arquitectura 2}
...
\begin{figure}[H]
	...
	\caption{Gráfica de aprendizaje para bajo en arquitectura 2}
...
A pesar de mostrar un comportamiento a la alza, los valores finales de esta gráfica no son tan alentadores.

\begin{figure}[H]
	\centerline{\includegraphics[width=12cm]{arq3_guitar_acc.png}}
	\caption{Gráfica de aprendizaje para guitarra en arquitectura 3}
...
Es interesante ver que de la época 75 a la 135 la tasa de aprendizaje se mantiene oscilando entre los mismos valores, alcanzando por algunas epocas valores mayores.
...
La primer nota de entrada que tenemos en el bajo es Fa y nos genera un Mi, después en el quinto compas volvemos a introducir un Fa y la salida obtenida resulta ser otro Fa.
...
En las figuras \ref{fig:arq1_guitar_val} y \ref{fig:arq1_bass_val} se puede observar que conforme van pasando las épocas, el numero de canciones creadas que poseen la misma tonalidad que la canción base va en aumento.
...
En las figuras \ref{fig:arq2_guitar_val} y \ref{fig:arq2_bass_val} se puede observar que conforme van pasando las épocas, el numero de canciones creadas que poseen la misma tonalidad que la canción base va en aumento, sin embargo el crecimiento en las canciones de bajo es mucho mas lento en comparación a la guitarra.
...
En las figuras \ref{fig:arq3_guitar_val} y \ref{fig:arq3_bass_val} se puede observar que conforme van pasando las épocas, el numero de canciones creadas que poseen la misma tonalidad que la canción base va en aumento, sin embargo el porcentaje final es bastante bajo después de 200 épocas.
...
En la figura \ref{fig:arqt_guitar_val} observamos que la arquitectura que tuvo mejores resultados fue la arquitectura 1, seguido de la arquitectura 2. El porcentaje de la arquitectura 3 es bastante bajo después de todas estas épocas.
