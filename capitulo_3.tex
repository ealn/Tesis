...
MIDI (Interfaz digital de instrumentos musicales) es un estándar técnico que describe un protocolo, una interfaz digital y conectores para la interoperatividad entre varios instrumentos musicales electrónicos, software y dispositivos. \cite{Lear_Coli}
...
Si se grafican los puntos de las coordenadas $(x, y)$ para esta tonalidad se vera que los puntos están demasiados dispersos entre si, por lo tanto no podemos encontrar una linea recta que prediga la posición de nuevos puntos.
