...
Finalmente el modulo de analizador como su nombre lo dice es el encargado de analizar las canciones generadas por el programa.

Si no se tienen canciones generadas por el programa este modulo no podrá ser usado.
