...
\begin{equation}
\sigma(z)_j = \frac{e^{z_t}}{\sum_{k=1}^{K}e^{z_k}} \ \  \textup{para $j$ = 1, ..., $K$}
\label{ec:softmax}
\end{equation}
...
\subsubsection{Arquitectura 1}

\subsubsection{Arquitectura 2}

\subsubsection{Arquitectura 3}

\subsubsection{Comparativa de las arquitecturas}

\subsection{Etapa de generación}
