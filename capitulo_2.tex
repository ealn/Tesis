...
\begin{figure}[H]
	\centerline{\includegraphics[width=4cm]{red_rec.png}}
...
\subsection{Decenso por gradiente}

El descenso por gradiente es la tecnica mas usada para entrenar y optimizar sistemas inteligentes. Es utilizada para realizar la actualizacion de los pesos en modelos de redes neuronales y minimizar la funcion de error $E(x)$, la forma en que actualiza los parametros es utilizando la siguiente ecuacion:
