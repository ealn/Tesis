...
\begin{figure}[H]
	\centerline{\includegraphics[width=14cm]{lstm.png}}
	\caption{Redes LSTM}
	\label{fig:lstm}
\end{figure}
...
\subsubsection{Descenso por gradiente estocástico (SGD)}
...
\subsubsection{Gradiente acelerado Nesterov}
...
Nadam (Estimación del momento adaptativo acelerado por Nesterov) por lo tanto, combina a Adán y NAG.
